# The objective of the document is to create a self customised (i) Pose, (ii) Frames and Colors

# (i) Mediapipe Pose as we won't need all 33 poses for Squat Analysis
# - nose is used to detect whether we are front facing or side facing the camera
# - hip, knee and ankle are to detect angle of knee
# - shoulder, elbow and wrist are used to implement correct squat posture
...
class ProcessFrame:
    def __init__(self, thresholds, flip_frame = False):
        ...
        # Font type.
        self.font = cv2.FONT_HERSHEY_SIMPLEX | cv2.FONT_HERSHEY_SCRIPT_SIMPLEX
    ...
    def process(self, frame: np.array, pose):
        ...
        if keypoints.pose_landmarks:
            ...
            if offset_angle > self.thresholds['OFFSET_THRESH']:
                ...
                draw_text(
                    frame, 
                    'Please Move Further and Side Face Camera', 
                ...
                draw_text(
                    frame, 
                    'Tilt Your Body to lower Angle '+ str(offset_angle), 
            ...
            # Camera is aligned properly.
                ...
                cv2.ellipse(frame, hip_coord, (30, 30), 
                            ...
                            color = self.COLORS['black'], thickness = 3, lineType = self.linetype)

                draw_dotted_line(frame, hip_coord, start=hip_coord[1]-80, end=hip_coord[1]+20, line_color=self.COLORS['black'])
                ...
                draw_dotted_line(frame, knee_coord, start=knee_coord[1]-50, end=knee_coord[1]+20, line_color=self.COLORS['black'])
                ...
                draw_dotted_line(frame, ankle_coord, start=ankle_coord[1]-50, end=ankle_coord[1]+20, line_color=self.COLORS['black'])
                ...
                if display_inactivity:
                    # cv2.putText(frame, 'Resetting COUNTERS due to inactivity!!!', (10, frame_height - 20), self.font, 0.5, 
                                                                            #self.COLORS['blue'], 2, lineType=self.linetype)
                    play_sound = 'reset_counters'
                    self.state_tracker['start_inactive_time'] = time.perf_counter()
                    self.state_tracker['INACTIVE_TIME'] = 0.0
                ...
                cv2.putText(frame, str(int(knee_vertical_angle)), (knee_text_coord_x, knee_coord[1]+10), self.font, 0.6,
                            self.COLORS['light_green'], 2, lineType=self.linetype)
